...
// readiness-tagger over that contact: membership-gated (Team/EIR only), AI-classified service
// tags, code-derived stops, written to the 7 GHL readiness fields (equality-guarded => idempotent).
// Mirrors pages/api/wix-sync.ts.
//
...
import { enrichContact } from '@/lib/enrichment/contactEngine';
